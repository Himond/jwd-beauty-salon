...
import by.epam.litvinko.beautysalon.connection.ConnectionCreator;
...
public class SimpleJdbcMain {
    public static void main(String[] args) {
        ...
        try (Connection connection = ConnectionCreator.createConnection();
            ...
            String sql = "SELECT users.id, role.role, users.username, users.password, users.email, users.first_name, users.last_name, users.is_active, users.data_joined, users.photo FROM users JOIN role ON users.role_id = role.id;" ;

            ResultSet resultSet = statement.executeQuery(sql);
            System.out.println();
            System.out.println(Role.ADMINISTRATOR.ordinal());
